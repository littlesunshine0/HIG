...
*Source: [File management (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/file-management)*
*Fetched: 2025-11-25*

> Some apps can support documents and files that people expect to manage throughout the system.

![patterns-file-management-intro.png]
...
![file-management-document-launcher.png]
