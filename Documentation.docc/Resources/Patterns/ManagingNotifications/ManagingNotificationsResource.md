...
*Source: [Managing notifications (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/managing-notifications)*
*Fetched: 2025-11-25*

> Notifications can give people timely and important information, whether the device is locked or in use.

![patterns-managing-notifications-intro.png]
