...
*Source: [Icons (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/icons)*
*Fetched: 2025-11-25*

> An effective icon is a graphic asset that expresses a single concept in ways people instantly understand.

![foundations-icons-intro.png]
...
![custom-icon-sizes.png]

![custom-icon-line-weights.png]
...
![character-in-glyph.png]

![abstract-text-in-glyph.png]
...
| --- | --- | --- |
| Cut | ![icons-symbols-meaning-cut] | `scissors` |
| Copy | ![icons-symbols-meaning-copy] | `document.on.document` |
| Paste | ![icons-symbols-meaning-paste] | `document.on.clipboard` |
| Done | ![icons-symbols-meaning-done-save] | `checkmark ` |
| Save |  |  |
| Cancel | ![icons-symbols-meaning-close-cancel] | `xmark` |
| Close |  |  |
| Delete | ![icons-symbols-meaning-delete] | `trash` |
| Undo | ![icons-symbols-meaning-undo] | `arrow.uturn.backward` |
| Redo | ![icons-symbols-meaning-redo] | `arrow.uturn.forward` |
| Compose | ![icons-symbols-meaning-compose] | `square.and.pencil` |
| Duplicate | ![icons-symbols-meaning-duplicate] | `plus.square.on.square` |
| Rename | ![icons-symbols-meaning-rename] | `pencil` |
| Move to | ![icons-symbols-meaning-move-to-folder] | `folder` |
| Folder |  |  |
| Attach | ![icons-symbols-meaning-attach] | `paperclip` |
| Add | ![icons-symbols-meaning-add] | `plus` |
| More | ![icons-symbols-meaning-more] | `ellipsis` |

### Selection

| Action | Icon | Symbol name |
| --- | --- | --- |
| Select | ![icons-symbols-meaning-select-all] | `checkmark.circle` |
| Deselect | ![icons-symbols-meaning-deselect-close] | `xmark` |
| Close |  |  |
| Delete | ![icons-symbols-meaning-delete] | `trash` |
...
| Action | Icon | Symbol name |
| --- | --- | --- |
| Superscript | ![icons-symbols-meaning-superscript] | `textformat.superscript` |
| Subscript | ![icons-symbols-meaning-subscript] | `textformat.subscript` |
| Bold | ![icons-symbols-meaning-bold] | `bold` |
| Italic | ![icons-symbols-meaning-italic] | `italic` |
| Underline | ![icons-symbols-meaning-underline] | `underline` |
| ​​Align Left | ![icons-symbols-meaning-align-left] | `text.alignleft` |
| Center | ![icons-symbols-meaning-align-center] | `text.aligncenter` |
| Justified | ![icons-symbols-meaning-align-justified] | `text.justify` |
| Align Right | ![icons-symbols-meaning-align-right] | `text.alignright` |

### Search

| Action | Icon | Symbol name |
| --- | --- | --- |
| Search | ![icons-symbols-meaning-search] | `magnifyingglass` |
| Find | ![icons-symbols-meaning-find] | `text.page.badge.magnifyingglass` |
| Find and Replace |  |  |
| Find Next |  |  |
| Find Previous |  |  |
| Use Selection for Find |  |  |
| Filter | ![icons-symbols-meaning-filter] | `line.3.horizontal.decrease` |

### Sharing and exporting

| Action | Icon | Symbol name |
| --- | --- | --- |
| Share | ![icons-symbols-meaning-sharing] | `square.and.arrow.up` |
| Export |  |  |
| Print | ![icons-symbols-meaning-print] | `printer` |

### Users and accounts

| Action | Icon | Symbol name |
| --- | --- | --- |
| Account | ![icons-symbols-meaning-account-user] | `person.crop.circle` |
| User |  |  |
| Profile |  |  |
...
| Action | Icon | Symbol name |
| --- | --- | --- |
| Dislike | ![icons-symbols-meaning-dislike] | `hand.thumbsdown` |
| Like | ![icons-symbols-meaning-like] | `hand.thumbsup` |

### Layer ordering

| Action | Icon | Symbol name |
| --- | --- | --- |
| Bring to Front | ![icons-symbols-meaning-bring-to-front] | `square.3.layers.3d.top.filled` |
| Send to Back | ![icons-symbols-meaning-send-to-back] | `square.3.layers.3d.bottom.filled` |
| Bring Forward | ![icons-symbols-meaning-bring-forward] | `square.2.layers.3d.top.filled` |
| Send Backward | ![icons-symbols-meaning-send-backwards] | `square.2.layers.3d.bottom.filled` |

### Other

| Action | Icon | Symbol name |
| --- | --- | --- |
| Alarm | ![icons-symbols-meaning-alarm] | `alarm` |
| Archive | ![icons-symbols-meaning-archive] | `archivebox` |
| Calendar | ![icons-symbols-meaning-calendar] | `calendar` |
...
![doc-icon-custom-1.png]

![doc-icon-custom-2.png]

![doc-icon-custom-3.png]
...
![doc-icon-parts-background-fill.png]

![doc-icon-parts-center-image.png]

![doc-icon-parts-text.png]
...
![doc-icon-fewer-details-1.png]

![doc-icon-fewer-details-2.png]

![doc-icon-fewer-details-3.png]
