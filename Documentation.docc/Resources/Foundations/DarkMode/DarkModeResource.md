...
*Source: [Dark Mode (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/dark-mode)*
*Fetched: 2025-11-25*
...
![foundations-dark-mode-intro.png]
...
![dark-mode-stocks-app-dark-only-mode.png]
...
![dark-mode-system-colors-light.png]

![dark-mode-system-colors-dark.png]
...
![dark-mode-icon-in-light-mode.png]

![dark-mode-icon-in-dark-mode.png]
...
![dark-mode-illustration-in-light-mode.png]

![dark-mode-illustration-in-dark-mode-incorrect.png]

![dark-mode-illustration-in-dark-mode-correct.png]
...
![dark-mode-label-in-light-mode.png]

![dark-mode-label-in-dark-mode.png]
...
![base-with-four-semantic-colors.png]

![elevated-with-four-semantic-colors.png]

![light-with-four-semantic-colors.png]
