...
*Source: [Color (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/color)*
*Fetched: 2025-11-25*

> Judicious use of color can enhance communication, evoke your brand, provide visual continuity, communicate status and feedback, and help people understand information.

![foundations-color-intro.png]
...
![color-inclusive-color-charts-english]

![color-inclusive-color-charts-chinese]
...
![colors-tinted-liquid-glass-overview.png]
...
![colors-liquid-glass-usage-incorrect]

![crossout.png]

![colors-liquid-glass-usage-correct]
...
![color-empty-background-glass-buttons]

![color-filled-background-glass-buttons]
...
![colors-accent-colors-picker-multicolor]
...
| --- | --- | --- | --- | --- | --- |
| Red | [red](/documentation/SwiftUI/Color/red) | ![colors-unified-red-light.png] | ![colors-unified-red-dark.png] | ![colors-unified-accessible-red-light.png] | ![colors-unified-accessible-red-dark.png] |
| Orange | [orange](/documentation/SwiftUI/Color/orange) | ![colors-unified-orange-light.png] | ![colors-unified-orange-dark.png] | ![colors-unified-accessible-orange-light.png] | ![colors-unified-accessible-orange-dark.png] |
| Yellow | [yellow](/documentation/SwiftUI/Color/yellow) | ![colors-unified-yellow-light.png] | ![colors-unified-yellow-dark.png] | ![colors-unified-accessible-yellow-light.png] | ![colors-unified-accessible-yellow-dark.png] |
| Green | [green](/documentation/SwiftUI/Color/green) | ![colors-unified-green-light.png] | ![colors-unified-green-dark.png] | ![colors-unified-accessible-green-light.png] | ![colors-unified-accessible-green-dark.png] |
| Mint | [mint](/documentation/SwiftUI/Color/mint) | ![colors-unified-mint-light.png] | ![colors-unified-mint-dark.png] | ![colors-unified-accessible-mint-light.png] | ![colors-unified-accessible-mint-dark.png] |
| Teal | [teal](/documentation/SwiftUI/Color/teal) | ![colors-unified-teal-light.png] | ![colors-unified-teal-dark.png] | ![colors-unified-accessible-teal-light.png] | ![colors-unified-accessible-teal-dark.png] |
| Cyan | [cyan](/documentation/SwiftUI/Color/cyan) | ![colors-unified-cyan-light.png] | ![colors-unified-cyan-dark.png] | ![colors-unified-accessible-cyan-light.png] | ![colors-unified-accessible-cyan-dark.png] |
| Blue | [blue](/documentation/SwiftUI/Color/blue) | ![colors-unified-blue-light.png] | ![colors-unified-blue-dark.png] | ![colors-unified-accessible-blue-light.png] | ![colors-unified-accessible-blue-dark.png] |
| Indigo | [indigo](/documentation/SwiftUI/Color/indigo) | ![colors-unified-indigo-light.png] | ![colors-unified-indigo-dark.png] | ![colors-unified-accessible-indigo-light.png] | ![colors-unified-accessible-indigo-dark.png] |
| Purple | [purple](/documentation/SwiftUI/Color/purple) | ![colors-unified-purple-light.png] | ![colors-unified-purple-dark.png] | ![colors-unified-accessible-purple-light.png] | ![colors-unified-accessible-purple-dark.png] |
| Pink | [pink](/documentation/SwiftUI/Color/pink) | ![colors-unified-pink-light.png] | ![colors-unified-pink-dark.png] | ![colors-unified-accessible-pink-light.png] | ![colors-unified-accessible-pink-dark.png] |
| Brown | [brown](/documentation/SwiftUI/Color/brown) | ![colors-unified-brown-light.png] | ![colors-unified-brown-dark.png] | ![colors-unified-accessible-brown-light.png] | ![colors-unified-accessible-brown-dark.png] |
...
| --- | --- | --- | --- | --- | --- |
| Gray | [systemGray](/documentation/UIKit/UIColor/systemGray) | ![ios-default-systemgray.png] | ![ios-default-systemgraydark.png] | ![ios-accessible-systemgray.png] | ![ios-accessible-systemgraydark.png] |
| Gray (2) | [systemGray2](/documentation/UIKit/UIColor/systemGray2) | ![ios-default-systemgray2.png] | ![ios-default-systemgray2dark.png] | ![ios-accessible-systemgray2.png] | ![ios-accessible-systemgray2dark.png] |
| Gray (3) | [systemGray3](/documentation/UIKit/UIColor/systemGray3) | ![ios-default-systemgray3.png] | ![ios-default-systemgray3dark.png] | ![ios-accessible-systemgray3.png] | ![ios-accessible-systemgray3dark.png] |
| Gray (4) | [systemGray4](/documentation/UIKit/UIColor/systemGray4) | ![ios-default-systemgray4.png] | ![ios-default-systemgray4dark.png] | ![ios-accessible-systemgray4.png] | ![ios-accessible-systemgray4dark.png] |
| Gray (5) | [systemGray5](/documentation/UIKit/UIColor/systemGray5) | ![ios-default-systemgray5.png] | ![ios-default-systemgray5dark.png] | ![ios-accessible-systemgray5.png] | ![ios-accessible-systemgray5dark.png] |
| Gray (6) | [systemGray6](/documentation/UIKit/UIColor/systemGray6) | ![ios-default-systemgray6.png] | ![ios-default-systemgray6dark.png] | ![ios-accessible-systemgray6.png] | ![ios-accessible-systemgray6dark.png] |
