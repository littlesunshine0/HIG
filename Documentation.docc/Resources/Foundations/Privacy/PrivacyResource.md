...
*Source: [Privacy (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/privacy)*
*Fetched: 2025-11-25*
...
![privacy-social-media-app-store-nutrition-labels.png]
...
| --- | --- | --- |
| ![checkmark.png] | The app records during the night to detect snoring sounds. | An active sentence that clearly describes how and why the app collects the data. |
| ![crossout.png] | Microphone access is needed for a better experience. | A passive sentence that provides a vague, undefined justification. |
| ![crossout.png] | Turn on microphone access. | An imperative sentence that doesn’t provide any justification. |
...
![privacy-custom-messaging-correct.png]
...
![privacy-custom-messaging-incorrect-cancel-button.png]

![crossout.png]

![privacy-custom-messaging-incorrect-close-button.png]
...
![privacy-social-media-map-location-alert.png]
