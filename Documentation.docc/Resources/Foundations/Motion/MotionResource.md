...
*Source: [Motion (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/motion)*
*Fetched: 2025-11-25*
...
SwiftUI provides a powerful and streamlined way to add motion to your app. If you need to use WatchKit to animate layout and appearance changes — or create animated image sequences — see [WKInterfaceImage](/documentation/WatchKit/WKInterfaceImage).
