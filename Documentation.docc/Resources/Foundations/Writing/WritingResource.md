...
*Source: [Writing (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/writing)*
*Fetched: 2025-11-25*

> The words you choose within your app are an essential part of its user experience.

![foundations-writing-intro.png]
...
![writing-fall-detection-message.png]

![writing-move-streak-message.png]
...
![writing-handwashing-settings.png]
