...
*Source: [Game Center (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/game-center)*
*Fetched: 2025-11-25*
...
![technologies-Game-Center-intro.png]
...
![games-access-point-collapsed.png]
...
> **Note**
> In visionOS, the locations of the access point vary based on game type, such as immersive or volume-based. For developer guidance, see [Adding an access point to your game](/documentation/GameKit/adding-an-access-point-to-your-game).
>
...
![games-achievement-overlay.png]

![games-achievement-overlay-detail.png]
...
![games-leaderboards-overlay.png]

![games-leaderboards-detail.png]
...
![games-challenges-overlay.png]

![games-challenges-overlay-detail.png]
...
![games-challenge-image-specs.png]
...
![games-multiplayer-overlay.png]

![games-multiplayer-overlay-detail.png]
...
![games-multiplayer-custom-code.png]
...
![games-multiplayer-in-game-ui.png]
...
![games-multiplayer-anatomy.png]

![games-multiplayer-image-specs.png]
