...
*Source: [AirPlay (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/airplay)*
*Fetched: 2025-11-25*
...
![technologies-AirPlay-intro.png]
...
|  | Example text |
| --- | --- |
| ![checkmark.png] | Use AirPlay to listen on your speaker |
| ![crossout.png] | AirPlay to your speaker |
| ![crossout.png] | You can AirPlay with [App Name] |

**Use terms like *works with*, *use*, *supports*, and *compatible*.**

|  | Example text |
| --- | --- |
| ![checkmark.png] | [App Name] is compatible with AirPlay |
| ![checkmark.png] | AirPlay-enabled speaker |
| ![checkmark.png] | You can use AirPlay with [App Name] |
| ![crossout.png] | [App Name] has AirPlay |

**Use the name *Apple* with the name *AirPlay* if desired.**

|  | Example text |
| --- | --- |
| ![checkmark.png] | Compatible with Apple AirPlay |
...
|  | Example text |
| --- | --- |
| ![checkmark.png] | [App Name] now supports AirPlay |
