...
*Source: [HomeKit (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/homekit)*
*Fetched: 2025-11-25*
...
![technologies-HomeKit-intro.png]
...
| --- | --- |
| ![checkmark.png] | Reading lamp |
| ![crossout.png] | 📚 lamp |
| ![checkmark.png] | 2nd garage door |
| ![crossout.png] | #2 garage door |
...
![homekit-lights-right.png]

![checkmark.png]

![homekit-lights-wrong1.png]

![crossout.png]

![homekit-lights-wrong2.png]
...
|  | Example text |
| --- | --- |
| ![checkmark.png] | Use HomeKit to turn on your lights from your iPhone or iPad. |
| ![crossout.png] | Use HomeKit to turn on your lights from your iOS devices. |
...
|  | Example text |
| --- | --- |
| ![checkmark.png] | [Brand] lightbulbs work with HomeKit. |
| ![checkmark.png] | HomeKit-enabled thermostat. |
| ![checkmark.png] | You can use HomeKit with [App Name]. |
| ![crossout.png] | HomeKit lightbulbs. |

**Don’t suggest that HomeKit is performing an action or function.**

|  | Example text |
| --- | --- |
| ![checkmark.png] | Back door is unlocked with HomeKit. |
| ![crossout.png] | HomeKit unlocked the back door. |

**Use the name *Apple* with the name *HomeKit*, if desired.**

|  | Example text |
| --- | --- |
| ![checkmark.png] | Compatible with Apple HomeKit. |

**Use the name *HomeKit* for setup, configuration, and instructions, if desired.**

|  | Example text |
| --- | --- |
| ![checkmark.png] | Open HomeKit settings. |
...
|  | Example text |
| --- | --- |
| ![checkmark.png] | Open the Apple Home app. |
| ![checkmark.png] | Open the Apple Home app. Your accessory and room will now appear in the Home app. |
| ![crossout.png] | Open Home. |
