...
*Source: [ID Verifier (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/id-verifier)*
*Fetched: 2025-11-25*

> ID Verifier lets your iPhone app read mobile IDs in person without requiring external hardware.

![technologies-ID-Verifier-Apps-intro.png]
...
| --- | --- |
| ![id-verifier-button-age.png] | An app that checks whether people are old enough to attend an event or access a venue, like a concert hall. |
| ![id-verifier-button-identity.png] | An app that verifies whether specific identity information matches expected values, such as name and birth date when picking up a rental car. |
