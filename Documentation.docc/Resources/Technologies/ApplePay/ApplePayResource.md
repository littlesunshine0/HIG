...
*Source: [Apple Pay (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/apple-pay)*
*Fetched: 2025-11-25*
...
![technologies-Apple-Pay-intro.png]
...
![custom-button-yes.png]

![checkmark.png]

![custom-button-no.png]
...
![payment-sheet-before-account.png]
...
| --- | --- |
| ![button-buy-with.png] | An area in an app or website where people can make a purchase, such as a product detail page or shopping cart page. |
| ![button-pay-with.png] | An app or website that lets people pay bills or invoices, such as those for a utility — like cable or electricity — or a service like plumbing or car repair. |
| ![button-check-out-with.png] | An app or website offering a shopping cart or purchase experience that includes other payment buttons that start with the text *Check out*. |
| ![button-continue-with.png] | An app or website offering a shopping cart or purchase experience that includes other payment buttons that start with the text *Continue with*. |
| ![button-book-with.png] | An app or website that helps people book flights, trips, or other experiences. |
| ![button-donate-with.png] | An app or website for an [Approved nonprofits](https://developer.apple.com/support/apple-pay-nonprofits/) that lets people make donations. |
| ![button-subscribe-with.png] | An app or website that lets people purchase a subscription, such as a gym membership or a meal-kit delivery service. |
| ![button-reload-with.png] | An app or website that uses the term *reload* to help people add money to a card, account, or payment system associated with a service, such as transit or a prepaid phone plan. |
| ![button-add-money-with.png] | An app or website that uses the term *add money* to help people add money to a card, account, or payment system associated with a service, such as transit or a prepaid phone plan. |
| ![button-top-up-with.png] | An app or website that uses the term *top up* to help people add money to a card, account, or payment system associated with a service, such as transit or a prepaid phone plan. |
| ![button-order-with.png] | An app or website that lets people place orders for items like meals or flowers. |
| ![button-rent-with.png] | An app or website that lets people rent items like cars or scooters. |
| ![button-support-with.png] | An app or website that uses the term *support* to help people give money to projects, causes, organizations, and other entities. |
| ![button-contribute-with.png] | An app or website that uses the term *contribute* to help people give money to projects, causes, organizations, and other entities. |
| ![button-tip-with.png] | An app or website that lets people tip for goods or services. |
| ![ap-button.png] | An app or website that has stylistic reasons to use a button that can have a smaller minimum width or that doesn’t specify a call to action. If you choose a payment button type that isn’t supported on the version of the operating system your app or website is running in, the system may replace it with this button. |
...
![apple-pay-black-yes.png]

![checkmark.png]

![apple-pay-black-no.png]
...
![apple-pay-outline-yes.png]

![checkmark.png]

![apple-pay-outline-no.png]
...
![apple-pay-white-yes.png]

![checkmark.png]

![apple-pay-white-no.png]
...
![ap-same-size-correct.png]

![checkmark.png]

![ap-smaller-incorrect.png]
...
![ap-right-side-correct.png]

![checkmark.png]

![ap-left-side-incorrect.png]
...
![minimum-corner-radii.png]

![default-corner-radii.png]

![maximum-corner-radii.png]
...
![minimum-apple-pay.png]

![minimum-apple-pay-donate.png]
...
![apple-pay-mark-with-payment-options.png]
...
|  | Example text |
| --- | --- |
| ![checkmark.png] | Purchase with Apple Pay |
| ![checkmark.png] | Purchase with Apple Pay® |
| ![crossout.png] | Purchase with ApplePay |
| ![crossout.png] | Purchase with  Pay |
| ![crossout.png] | Purchase with APPLE PAY |
