...
*Source: [HealthKit (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/healthkit)*
*Fetched: 2025-11-25*

> HealthKit is the central repository for health and fitness data in iOS, iPadOS, and watchOS.

![technologies-HealthKit-intro.png]
...
![health-icon-onboard-screen.png]
