...
*Source: [Siri (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/siri)*
*Fetched: 2025-11-25*

> Siri makes it easy for people to accomplish everyday tasks quickly, using voice, touch, or automation.

![technologies-Siri-intro.png]
...
|  | Example title |
| --- | --- |
| ![checkmark.png] | *Order my favorite coffee* |
| ![crossout.png] | *Large latte* |
| ![checkmark.png] | *Show today’s forecast* |
| ![crossout.png] | *Weather forecast* |
...
|  | Example text |
| --- | --- |
| ![checkmark.png] | *Say Hey Siri to activate Siri.* |
| ![checkmark.png] | *Say “Hey Siri” to activate Siri.* |
| ![crossout.png] | *Say Hey Siri… to activate Siri.* |
| ![crossout.png] | *Say “hey Siri” to activate Siri.* |
