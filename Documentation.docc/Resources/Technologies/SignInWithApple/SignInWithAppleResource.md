...
*Source: [Sign in with Apple (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/sign-in-with-apple)*
*Fetched: 2025-11-25*
...
![create-account-after-purchase.png]
...
![apple-account-sign-in-with.png]

![apple-account-sign-up-with.png]

![apple-account-continue-with.png]

For watchOS, the system provides one title:  Sign in.

![apple-account-watch-44mm-no-background.png]
...
![apple-account-white-yes.png]

![checkmark.png]

![apple-account-white-no.png]
...
![apple-account-outline-yes.png]

![checkmark.png]

![apple-account-outline-no.png]
...
![apple-account-black-yes.png]

![checkmark.png]

![apple-account-black-no.png]
...
![apple-account-minimum-corner-radii.png]

![apple-account-default-corner-radii.png]

![apple-account-maximum-corner-radii.png]
...
![siwa-black-logo-only.png]

![siwa-white-logo-only.png]
...
![left-aligned-correct-proportions-2.png]

![left-aligned-correct-proportions-1.png]
...
![siwa-logo-masked-rounded-rect.png]

![siwa-logo-default.png]

![siwa-logo-masked-circle.png]
