...
*Source: [Search fields (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/search-fields)*
*Fetched: 2025-11-25*

> A search field lets people search a collection of content for specific terms they enter.

![components-search-field-intro.png]
...
![search-fields-scope-control-tokens.png]
...
![search-fields-ios-toolbar-with-items.png]

![search-fields-ios-navigation-bar-item.png]
...
![search-fields-toolbar-search-ipad.png]

![search-fields-toolbar-search-mac.png]
...
![search-fields-ipad-search-in-sidebar.png]
...
![search-fields-ipad-search-in-tab-bar.png]
