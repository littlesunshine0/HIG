...
*Source: [Sidebars (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/sidebars)*
*Fetched: 2025-11-25*

> A sidebar appears on the leading side of a view and lets people navigate between sections in your app or game.

![components-sidebar-intro.png]
...
![sidebars-extend-content-beneath-sidebar-incorrect.png]

![crossout.png]

![sidebars-extend-content-beneath-sidebar-correct.png]
