...
*Source: [Token fields (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/token-fields)*
*Fetched: 2025-11-25*

> A token field is a type of text field that can convert text into *tokens* that are easy to select and manipulate.

![components-token-field-intro.png]
