...
*Source: [Tab bars (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/tab-bars)*
*Fetched: 2025-11-25*

> A tab bar lets people navigate between top-level sections of your app.

![components-tab-bar-intro.png]
...
![tab-bar-with-accessory-expanded.png]

![tab-bar-with-accessory-collapsed.png]
...
![visionos-tab-bar-collapsed.png]

![visionos-tab-bar-expanded.png]
