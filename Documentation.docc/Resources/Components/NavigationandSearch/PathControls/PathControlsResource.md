...
*Source: [Path controls (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/path-controls)*
*Fetched: 2025-11-25*

> A path control shows the file system path of a selected file or folder.

![components-path-control-intro.png]
