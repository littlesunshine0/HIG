...
*Source: [Segmented controls (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/segmented-controls)*
*Fetched: 2025-11-25*

> A segmented control is a linear set of two or more segments, each of which functions as a button.

![components-segmented-control-intro.png]
...
![segmented-control-one-choice.png]

![segmented-control-multiple-choices.png]
...
![segmented-controls-phone-recents.png]
...
![segmented-controls-mac-calendar.png]

**Size custom interface icons appropriately based on the size of the control.** Use the following values for guidance.

![segmented-control-icons-regular.png]

![segmented-control-icons-small.png]

![segmented-control-icons-mini.png]
