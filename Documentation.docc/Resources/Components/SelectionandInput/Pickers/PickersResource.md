...
*Source: [Pickers (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/pickers)*
*Fetched: 2025-11-25*

> A picker displays one or more scrollable lists of distinct values that people can choose from.

![components-pickers-intro.png]
...
![pickers-navigation-button-watch]

![pickers-navigation-list-watch]
