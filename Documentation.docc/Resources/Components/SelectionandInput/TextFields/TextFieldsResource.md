...
*Source: [Text fields (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/text-fields)*
*Fetched: 2025-11-25*

> A text field is a rectangular area in which people enter or edit small, specific pieces of text.

![components-text-field-intro.png]
...
![text-fields-formatted-text.png]
...
![text-fields-clipped-text.png]

![text-fields-wrapped-text.png]

![text-fields-truncated-text.png]
