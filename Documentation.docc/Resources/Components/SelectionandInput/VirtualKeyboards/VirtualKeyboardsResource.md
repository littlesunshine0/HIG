...
*Source: [Virtual keyboards (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/virtual-keyboards)*
*Fetched: 2025-11-25*

> On devices without physical keyboards, the system offers various types of virtual keyboards people can use to enter data.

![components-virtual-keyboard-intro.png]
...
![ui-fully-visible.png]

![checkmark.png]

![text-field-hidden.png]
