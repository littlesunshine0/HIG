...
*Source: [Status bars (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/status-bars)*
*Fetched: 2025-11-25*

> A status bar appears along the upper edge of the screen and displays information about the device’s current state, like the time, cellular carrier, and battery level.

![components-status-bar-intro.png]
...
![status-bar-visible.png]

![status-bar-hidden.png]
