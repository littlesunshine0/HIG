...
*Source: [Toolbars (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/toolbars)*
*Fetched: 2025-11-25*

> A toolbar provides convenient access to frequently used commands, controls, navigation, and search.

![components-toolbar-intro.png]
...
![toolbars-navigation-action-back-incorrect.png]

![crossout.png]

![toolbars-navigation-action-back-correct.png]
...
![toolbars-prefer-symbols-incorrect.png]

![crossout.png]

![toolbars-prefer-symbols-correct.png]
...
![toolbars-icons-circle-outline-incorrect.png]

![crossout.png]

![toolbars-icons-no-outline-correct.png]
...
![toolbars-prominent-action-tinted]
...
![toolbars-layout-grouping-incorrect.png]

![crossout.png]

![toolbars-layout-grouping-correct.png]
...
![toolbars-layout-text-action-grouping-incorrect.png]

![crossout.png]

![toolbars-layout-text-action-grouping-correct.png]
...
![visionos-toolbar-notes-app.png]
...
![visionos-toolbar-standard-layout.png]
...
![toolbars-watch-top-buttons.png]

![toolbars-watch-bottom-buttons.png]
...
![toolbars-watch-primary-button-hidden.png]

![toolbars-watch-primary-button-visible.png]
