...
*Source: [Activity views (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/activity-views)*
*Fetched: 2025-11-25*

> An activity view — often called a *share sheet* — presents a range of tasks that people can perform in the current context.

![components-activity-view-intro.png]
...
![activity-views-share-button.png]

![activity-views-share-sheet.png]
