...
*Source: [The menu bar (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/the-menu-bar)*
*Fetched: 2025-11-25*

> On a Mac or an iPad, the menu bar at the top of the screen displays the top-level menus in your app or game.

![components-the-menu-bar-intro.png]
