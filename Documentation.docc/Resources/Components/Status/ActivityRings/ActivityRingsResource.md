...
*Source: [Activity rings (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/activity-rings)*
*Fetched: 2025-11-25*

> Activity rings show an individual’s daily progress toward Move, Exercise, and Stand goals.

![components-activity-ring-intro.png]
...
| Move | Exercise | Stand |
| --- | --- | --- |
| ![activity-rings-color-swatch-red.png] | ![activity-rings-color-swatch-green.png] | ![activity-rings-color-swatch-blue.png] |
...
![activity-rings-watch-paired.png]

![activity-rings-no-watch-paired.png]
