...
*Source: [Progress indicators (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/progress-indicators)*
*Fetched: 2025-11-25*

> Progress indicators let people know that your app isn’t stalled while it loads content or performs lengthy operations.

![components-progress-indicators-intro.png]
...
![progress-indicator-determinate-bar.png]

![progress-indicator-determinate-circle.png]
...
![progress-indicator-intermediate-spinner.png]

![activity-indicators-watch.png]
...
![progress-indicator-intermediate-bar.png]
...
![progress-bar-watch.png]

![progress-ring-watch.png]
