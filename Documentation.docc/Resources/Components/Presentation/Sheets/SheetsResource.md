...
*Source: [Sheets (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/sheets)*
*Fetched: 2025-11-25*

> A sheet helps people perform a scoped task that’s closely related to their current context.

![components-sheet-intro.png]
...
![sheets-nonmodal-notes-text-regular.png]

![sheets-nonmodal-notes-text-italic.png]
...
![sheets-large-detent.png]

![sheets-medium-detent.png]
...
![modal-sheet-watchos-do.png]

![checkmark.png]

![modal-sheet-watchos-do-not-1.png]

![crossout.png]

![modal-sheet-watchos-do-not-2.png]
