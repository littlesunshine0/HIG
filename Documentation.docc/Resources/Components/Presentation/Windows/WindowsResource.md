...
*Source: [Windows (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/windows)*
*Fetched: 2025-11-25*

> A window presents UI views and components in your app or game.

![components-window-intro.png]
...
![visionos-window-style-2d-window.png]

![visionos-window-style-3d-volume.png]
...
![visionos-window-2d-with-volume.png]
