...
*Source: [Page controls (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/page-controls)*
*Fetched: 2025-11-25*

> A page control displays a row of indicator images, each of which represents a page in a flat list.

![components-page-dots-intro.png]
...
![page-indicator-customization-incorrect.png]

![crossout.png]

![page-indicator-customization-correct.png]
...
![page-controls-many-indicators.png]
...
![page-controls-watch-vertical]

![page-controls-watch-horizontal]
