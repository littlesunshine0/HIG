...
*Source: [Action sheets (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/action-sheets)*
*Fetched: 2025-11-25*

> An action sheet is a modal view that presents choices related to an action people initiate.

![components-action-sheet-intro.png]
...
![action-sheet-iphone-mail.png]

![action-sheet-iphone-mail-delete-action.png]
...
![action-sheet-watch-system-defined.png]
