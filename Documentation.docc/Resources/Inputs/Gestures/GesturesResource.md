...
*Source: [Gestures (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/gestures)*
*Fetched: 2025-11-25*

> A gesture is a physical motion that a person uses to directly affect an object in an app or game on their device.

![inputs-gestures-intro.png]
...
![visionos-custom-spatial-gesture-happy-beam.png]
...
![visionos-hand-area-of-focus.png]

![visionos-spatial-gesture-home-indicator.png]

![visionos-spatial-gesture-control-center.png]
...
![gestures-default-home-indicator.png]

![gestures-home-indicator-in-immersive-space.png]

![gestures-fully-immersive-game-with-glove.png]
