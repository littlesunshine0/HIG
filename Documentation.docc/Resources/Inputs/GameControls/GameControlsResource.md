...
*Source: [Game controls (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/game-controls)*
*Fetched: 2025-11-25*

> Precise, intuitive game controls enhance gameplay and can increase a player’s immersion in the game.

![inputs-game-controls-intro.png]
...
![game-controls-touch-input-heat-map.png]
...
![game-controls-button-to-action.png]
...
![game-controls-power-up-action.png]
...
![game-controls-camera-thumbstick-zones.png]
...
![game-controls-controller-anatomy.png]
...
![game-controls-sf-symbols-gaming-category.png]
