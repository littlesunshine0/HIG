...
*Source: [Eyes (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/eyes)*
*Fetched: 2025-11-25*

> In visionOS, people look at a virtual object to identify it as a target they can interact with.

![inputs-eyes-intro.png]
...
![visionos-eyes-sharp-button-incorrect.png]

![crossout.png]

![visionos-eyes-rounded-button-correct.png]
