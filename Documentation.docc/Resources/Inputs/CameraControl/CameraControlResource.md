...
*Source: [Camera Control (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/camera-control)*
*Fetched: 2025-11-25*

> The Camera Control provides direct access to your app’s camera experience.

![inputs-camera-control-intro.png]
...
![camera-control-button-callout.png]
...
![camera-control-slider-control.png]

![camera-control-picker-control.png]
...
![system-control-type-zoom-factor.png]

![system-control-type-exposure-bias.png]
...
![camera-control-picker-sf-symbols-flash.png]

![camera-control-picker-sf-symbols-filters.png]
...
![system-control-with-label.png]

![checkmark.png]

![system-control-no-label.png]
...
![camera-control-portrait-landscape-orientation.png]
...
![camera-control-screen-ui-good-example.png]

![checkmark.png]

![camera-control-screen-ui-bad-example.png]
