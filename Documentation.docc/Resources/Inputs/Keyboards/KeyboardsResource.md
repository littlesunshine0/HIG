...
*Source: [Keyboards (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/keyboards)*
*Fetched: 2025-11-25*

> A physical keyboard can be an essential input device for entering text, playing games, controlling apps, and more.

![inputs-keyboard-intro.png]
...
| --- | --- | --- |
| Command | ![Keyboard_Command.svg] | Prefer the Command key as the main modifier key in a custom keyboard shortcut. |
| Shift | ![Keyboard_Shift.svg] | Prefer the Shift key as a secondary modifier that complements a related shortcut. |
| Option | ![Keyboard_Option.svg] | Use the Option modifier sparingly for less-common commands or power features. |
| Control | ![Keyboard_Control.svg] | Avoid using the Control key as a modifier. The system uses Control in many systemwide features and shortcuts, like moving focus or capturing screenshots. |
