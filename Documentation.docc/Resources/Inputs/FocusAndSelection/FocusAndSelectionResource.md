...
*Source: [Focus and selection (Apple HIG)](https://developer.apple.com/design/human-interface-guidelines/focus-and-selection)*
*Fetched: 2025-11-25*

> Focus helps people visually confirm the object that their interaction targets.

![inputs-focus-and-selection-intro.png]
...
![focus-and-selection-halo-focus-effect.png]
...
![focus-and-selection-customized-halo.png]
...
![focus-and-selection-highlighted-appearance.png]
...
| State | Description |
| --- | --- |
| ![focus-and-selection-state-unfocused.png] | The viewer hasn’t brought focus to the item. Unfocused items appear less prominent than focused items. |
| ![focus-and-selection-state-focused.png] | The viewer brings focus to the item. A focused item visually stands out from the other onscreen content through elevation to the foreground, illumination, and animation. |
| ![focus-and-selection-state-highlighted.png] | The viewer chooses the focused item. A focused item provides instant visual feedback when people choose it. For example, a button might briefly invert its colors and animate before it transitions to its selected appearance. |
| ![focus-and-selection-state-selected.png] | The viewer has chosen or activated the item in some way. For example, a heart-shaped button that people can use to favorite a photo might appear filled in the selected state and empty in the deselected state. |
| ![focus-and-selection-state-unavailable.png] | The viewer can’t bring focus to the item or choose it. An unavailable item appears inactive. |
